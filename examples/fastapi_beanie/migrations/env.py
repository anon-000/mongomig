...
from catalog.models import DOCUMENTS

target_metadata = MongoMetadata.default()
target_metadata.register_beanie(*DOCUMENTS)  # storage profile "beanie" is applied automatically
